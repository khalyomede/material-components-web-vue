	...
	div
		mdc-grid
			mdc-grid-row
				...
				mdc-grid-cell(desktop="12" tablet="8" phone="4")
					mdc-card
						mdc-card-content
							h2(v-typography="'headline6'") Grid
						mdc-card-content(:padding="false")
							mdc-tab
								mdc-tab-item(icon="desktop_mac" active) Preview
								mdc-tab-item(icon="code") Code
								mdc-tab-content(slot="content" active)
									example-mdc-grid
								mdc-tab-content(slot="content" v-text-center)
									base-code(lang="html") {{ grid }}
				mdc-grid-cell(desktop="4" tablet="4" phone="4")
					mdc-card
						mdc-card-content
							h2(v-typography="'headline6'") FAB
						mdc-card-content(:padding="false")
							mdc-tab
								mdc-tab-item(icon="desktop_mac" active) Preview
								mdc-tab-item(icon="code") Code
								mdc-tab-content(slot="content" active)
									| You can see the component fixed at the bottom right of your screen.
									example-mdc-fab
								mdc-tab-content(slot="content" v-text-center)
									base-code(lang="html") {{ fab }}
				mdc-grid-cell(desktop="4" tablet="4" phone="4")
					mdc-card
						mdc-card-content
							h2(v-typography="'headline6'") Top app bar
						mdc-card-content(:padding="false")
							mdc-tab
								mdc-tab-item(icon="desktop_mac" active) Preview
								mdc-tab-item(icon="code") Code
								mdc-tab-content(slot="content" active)
									| See the Code tab to know how to use this component.
								mdc-tab-content(slot="content" v-text-center)
									base-code(lang="html") {{ topAppBar }}
				mdc-grid-cell(desktop="4" tablet="4" phone="4")
					mdc-card
						mdc-card-content
							h2(v-typography="'headline6'") Tab
						mdc-card-content(:padding="false")
							mdc-tab
								mdc-tab-item(icon="desktop_mac" active) Preview
								mdc-tab-item(icon="code") Code
								mdc-tab-content(slot="content" active)
									| You can see a tab example right above.
								mdc-tab-content(slot="content" v-text-center)
									base-code(lang="html") {{ tab }}
		div
			br
</template>
<script>
	...
	import ExampleMdcFab from "../component/example/MdcFab.vue";
	import ExampleMdcGrid from "../component/example/MdcGrid.vue";
	...
	import ExampleMdcTab from "../component/example/MdcTab.vue";
